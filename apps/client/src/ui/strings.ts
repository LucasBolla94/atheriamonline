...
export const strings = {
  ...
  lounge: {
    title: 'Meeting rooms',
    description:
      'A private space for your people. Free reservations, right beside the city square.',
    rules: '30 or 60 minutes · Up to 7 days ahead · At most 2 active or upcoming meetings per host',
    agenda: 'My meetings',
    ...
    now: 'Now',
    later: 'Choose a time',
    localTime: 'Date and time (your local time)',
    duration: 'Duration',
    minutes: (count: number): string => `${count} minutes`,
    capacity: (count: number): string => `${count} people, including you`,
    available: 'Reserved times',
    noOccupied: 'No reservations for this room yet.',
    empty: 'No upcoming meetings. Reserve a room or ask a host to invite you.',
    hosted: 'You are hosting',
    invited: 'You are invited',
    enter: 'Enter meeting',
    future: 'Entry opens at the start time.',
    ended: 'This meeting has ended.',
    guests: 'Invited residents',
    guestName: 'Resident name',
    invite: 'Invite',
    remove: 'Remove',
    noGuests: 'No invitations yet.',
    cancel: 'Cancel meeting',
    confirmCancel: 'Confirm cancellation',
    keep: 'Keep meeting',
    cancelled: 'Meeting cancelled.',
    saved: 'Your room is reserved.',
    invitedSuccess: 'Invitation updated.',
    removed: 'Invitation removed. The resident will leave the meeting.',
    loading: 'Loading reservations…',
    close: 'Close',
    back: 'Lounge',
    endWarning: (minutes: number): string =>
      `Meeting ends in ${minutes} min. You will return to the lounge.`,
    ends: (time: string): string => `Ends at ${time}`,
    enterFailed:
      'Entry was not confirmed. Stay in Central Lounge and check that the meeting is active and has space.',
    badTime: 'Choose a valid local date and time.',
  },
  landing: {
  ...
  shop: {
    ...
    subtitle: 'Buy from this business with your in-game Crowns.',
    listTitle: 'Sell an item',
    item: 'Item from your inventory',
    choose: 'Choose an item',
    price: 'Price in Crowns',
    priceHelp: 'For example, 12.50. The listed item stays reserved until sold or withdrawn.',
    list: 'List item for sale',
    listed: 'Your item is now listed for sale.',
    noInventory: 'You have no items available to list.',
    empty: 'No items are listed here yet.',
    review: 'Review item purchase',
    confirm: 'Buy this item',
    cancel: 'Cancel',
    withdraw: 'Withdraw listing',
    withdrawn: 'The listing was withdrawn. The item is back in your inventory.',
    bought: 'Purchase complete. The item is in your inventory.',
    balance: 'Your balance',
    loading: 'Loading the shop…',
    reviewHelp: 'You receive this one item. The full price goes to its seller.',
    close: 'Back to the environment',
  },
  house: {
    title: 'Your house',
